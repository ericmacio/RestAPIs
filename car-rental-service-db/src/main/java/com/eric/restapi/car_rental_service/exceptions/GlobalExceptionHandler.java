package com.eric.restapi.car_rental_service.exceptions;
...
class GlobalExceptionHandler {
    ...
    @ExceptionHandler({NotFoundException.class, NoSuchElementException.class, NumberFormatException.class})
